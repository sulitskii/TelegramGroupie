...
def test_encryption_consistency(encryption):
    ...
    with patch.object(encryption, 'encrypt_message', side_effect=[
        {'ciphertext': 'encrypted1', 'encrypted_data_key': 'key1', 'iv': 'iv1', 'salt': 'salt1'},
        {'ciphertext': 'encrypted2', 'encrypted_data_key': 'key2', 'iv': 'iv2', 'salt': 'salt2'}
    ]), patch.object(encryption, 'decrypt_message', return_value="Test message"):
        test_message = "Test message"
