...
class TestDatabaseClient(DatabaseClient):
    ...
    def _seed_test_data(self):
        ...
        self._collections["messages"] = [
            TestDatabaseDocument(f"msg_{i}", data) for i, data in enumerate(messages_data)
        ]
...
class TestEncryptionService(EncryptionService):
    ...
    def __init__(self, project_id: str = "test-project", location_id: str = "global", 
                 key_ring_id: str = "test-key-ring", key_id: str = "test-key"):
    ...
    def decrypt_message(self, encrypted_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            return f"[Test: Decryption Error] {str(e)}"
...
class TestTelegramMessage:
    ...
    def __init__(self, message_id: int, text: str, chat: "TestTelegramChat", 
...
class TestTelegramChat:
    ...
    def __init__(self, chat_id: int, title: str = None, chat_type: str = "group"):
        self.id = chat_id
        self.title = title
        self.type = chat_type
